...
<head lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="a{{ asset('pp/css/swiper.min.css') }}">
                ...
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title text-centre ">
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">{{$six->name}}</h4>
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                          ...
                          @foreach($six->posts()->take(3)->get() as $sixes)
                           ...
                           <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="case-item">
                                    ...
                                    <h6 class="case-item__title"><a href="#">{{$sixes->title}}</a></h6>
                                </div>
                            </div>
